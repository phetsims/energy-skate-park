...
(4) Open in the browser: `http://localhost/energy-skate-park/energy-skate-park_en.html`
...
(3) Open in the
browser: `http://localhost/energy-skate-park/build/adapted-from-phet/energy-skate-park_en_adapted-from-phet.html`
