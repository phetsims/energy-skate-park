...
const kineticEnergyLabelString = energySkateParkStrings.kineticEnergyLabel;
const potentialEnergyLabelString = energySkateParkStrings.potentialEnergyLabel;
const thermalEnergyLabelString = energySkateParkStrings.thermalEnergyLabel;
const totalEnergyLabelString = energySkateParkStrings.totalEnergyLabel;
const timeSwitchLabelString = energySkateParkStrings.timeSwitchLabel;
const positionSwitchLabelString = energySkateParkStrings.positionSwitchLabel;
const plotsEnergyGraphString = energySkateParkStrings.plots[ 'energy-graph' ];
