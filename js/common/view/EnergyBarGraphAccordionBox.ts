...
export default class EnergyBarGraphAccordionBox extends AccordionBox {
  ...
  public constructor( skater: Skater, barGraphScaleProperty: NumberProperty, barGraphVisibleProperty: BooleanProperty, resetEmitter: Emitter, showPatternsProperty: TReadOnlyProperty<boolean>, tandem: Tandem, providedOptions: EnergyBarGraphAccordionBoxOptions ) {
    ...
    const energyBarGraph = new EnergyBarGraph( skater, barGraphScaleProperty, barGraphVisibleProperty, resetEmitter, showPatternsProperty, tandem.createTandem( 'energyBarGraph' ), options.barGraphOptions );
