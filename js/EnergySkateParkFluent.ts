...
addToMapIfDefined( 'a11y_pieChart_energiesListPattern', 'a11y.pieChart.energiesListPatternStringProperty' );
...
const EnergySkateParkFluent = {
  ...
  a11y: {
    ...
    pieChart: {
      ...
      energiesListPattern: new FluentPattern<{ first: FluentVariable, second: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_pieChart_energiesListPattern', _.get( EnergySkateParkStrings, 'a11y.pieChart.energiesListPatternStringProperty' ), [{"name":"first"},{"name":"second"}] ),
    ...
    gravityComboBox: {
      ...
      gravityValuePattern: new FluentPattern<{ units: 'metersPerSecondSquared' | 'newtonsPerKilogram' | TReadOnlyProperty<'metersPerSecondSquared' | 'newtonsPerKilogram'>, value: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gravityComboBox_gravityValuePattern', _.get( EnergySkateParkStrings, 'a11y.gravityComboBox.gravityValuePatternStringProperty' ), [{"name":"units","variants":["metersPerSecondSquared","newtonsPerKilogram"]},{"name":"value"}] ),
